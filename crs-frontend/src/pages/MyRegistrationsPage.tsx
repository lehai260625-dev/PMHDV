...
=== 'DA_DANG_KY');
// Ghep ten mon hoc cho tung dong - goi song song bangPromise.all cho nhanh
...
// Neu khong lay duoc ten mon (vi du mon da bi Adminxoa), van hien dong nay
...
{cancellingId === row.id ? 'Dang huy...' : 'Huydang ky'}
